...
namespace Culturapp.Migrations
{
    ...
    [Migration("20250417023729_RenameOrganizerToCompany")]
    partial class RenameOrganizerToCompany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Culturapp.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Culturapp.Models.Address", b =>
                {
                    b.HasOne("Culturapp.Models.Company", "Company")
                        .WithOne("Address")
                        .HasForeignKey("Culturapp.Models.Address", "CompanyId")
