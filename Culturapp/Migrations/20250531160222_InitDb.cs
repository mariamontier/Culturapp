        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CheckingDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EnterpriseUsers_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Events_EnterpriseUsers_EnterpriseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Telephones_EnterpriseUsers_EnterpriseId",
                        column: x => x.EnterpriseId,
                        principalTable: "EnterpriseUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientUsers_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClientUsers_Telephones_PhoneId",
                        column: x => x.PhoneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientUsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckingsUsers_ClientUsers_ClientUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventUsers", x => new { x.ClientUsersId, x.EventsId });
                    table.ForeignKey(
                        name: "FK_EventUsers_ClientUsers_ClientUsersId",
                        column: x => x.ClientUsersId,
                        principalTable: "ClientUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckingsUsers_ClientUsersId",
                table: "CheckingsUsers",
                column: "ClientUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientUsers_AddressId",
                table: "ClientUsers",
                column: "AddressId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientUsers_PhoneId",
                table: "ClientUsers",
                column: "PhoneId");

            migrationBuilder.CreateIndex(
                name: "IX_EnterpriseUsers_AddressId",
